...
class LinkedList:
    ...
    # Common question in interviews
    def reverse(self):
        if self.length==0:
            return False
        elif self.length==1:
            return True
        # First reverse tail and head
        ...
        # print("temp ",temp.value)
        #Next, setup variable we will use in for loop
        before = None
        after = temp.next
...
my_linked_list.print_list() # prints LL: 2 1
